...
TLPM_PID_PM100Dx_DFU = (
    0x8099  # PM100D2\D3 Generation on USB with DFU interface enabled (Interface 0 TMC, Interface 1 DFU)
)
TLPM_FIND_PATTERN = "USB?*INSTR{VI_ATTR_MANF_ID==0x1313 && (VI_ATTR_MODE _CODE==0x8070 || VI_ATTR_MODE _CODE==0x8078)}"
PM100A_FIND_PATTERN = (
    "USB?*INSTR{VI_ATTR_MANF_ID==0x1313 && (VI_ATTR_MODE _CODE==0x8071 || VI_ATTR_MODE _CODE==0x8079)}"
)
PM100USB_FIND_PATTERN = "USB?*INSTR{VI_ATTR_MANF_ID==0x1313 && VI_ATTR_MODE _CODE==0x8072}"
PM160USB_FIND_PATTERN = (
    "USB?*INSTR{VI_ATTR_MANF_ID==0x1313 && (VI_ATTR_MODE _CODE==0x8073 || VI_ATTR_MODE _CODE==0x807B)}"
)
PM160TUSB_FIND_PATTERN = (
    "USB?*INSTR{VI_ATTR_MANF_ID==0x1313 && (VI_ATTR_MODE _CODE==0x8074 || VI_ATTR_MODE _CODE==0x807C)}"
)
...
PMxxx_FIND_PATTERN = (
    "USB?*INSTR{VI_ATTR_MANF_ID==0x1313 && (VI_ATTR_MODE _CODE==0x8070 || VI_ATTR_MODE _CODE==0x8078 || "
...
PMBT_FIND_PATTERN = (
    "ASR ?*::INSTR{VI_ATTR_MANF_ID==0x1313 && (VI_ATTR_MODE _CODE==0x807C || VI_ATTR_MODE _CODE==0x807B)}"
)
PMUART_FIND_PATTERN_VISA = "ASRL?*::INSTR"
PMUART_FIND_PATTERN_COM = "COM?*"
PMNET_FIND_PATTERN = (
    'TCPIP?*::INSTR{(VI_ATTR_TCPIP_DEVICE_NAME=="PM5020" || VI_ATTR_TCPIP_DEVICE_NAME=="PM103E" || '
...
TLPM_STATBIT_OPER_SETT = (
    0x0002  # < The instrument is waiting for signals it controls to stabilize enough to begin measurements.
)
...
TLPM_STATBIT_AUX_IPS = (
    0x0080  # < Apple(tm) authentification supported. True if an authentification co-processor is installed.
)
TLPM_STATBIT_AUX_IPF = (
    0x0100  # < Apple(tm) authentification failed. True if the authentification setup procedure failed.
)
...
class TLPMX:
    ...
    def getRsrcInfo(self, index, modelName, serialNumber, manufacturer, deviceAvailable):
        ...
        Returns:
                int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPMX_getRsrcInfo(
            self.devSession, index, modelName, serialNumber, manufacturer, deviceAvailable
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def getPowerCalibrationPointsInformation(
        self, index, serialNumber, calibrationDate, calibrationPointsCount, author, sensorPosition, channel
    ):
        """
        ...
        Returns:
                int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPMX_getPowerCalibrationPointsInformation(
            self.devSession,
            index,
            serialNumber,
            calibrationDate,
    ...
    def getPowerCalibrationPoints(self, index, pointCounts, wavelengths, powerCorrectionFactors, channel):
        ...
        Returns:
                int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPMX_getPowerCalibrationPoints(
            self.devSession, index, pointCounts, wavelengths, powerCorrectionFactors, channel
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult

    def setPowerCalibrationPoints(
        self, index, pointCounts, wavelengths, powerCorrectionFactors, author, sensorPosition, channel
    ):
        """
        ...
        Returns:
                int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPMX_setPowerCalibrationPoints(
            self.devSession, index, pointCounts, wavelengths, powerCorrectionFactors, author, sensorPosition, channel
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def getExtNtcParameter(self, attribute, r0Coefficient, betaCoefficient, channel):
        ...
        Returns:
                int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPMX_getExtNtcParameter(
            self.devSession, attribute, r0Coefficient, betaCoefficient, channel
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def getPositionAnalogOutputVoltageRange(self, minVoltage, maxVoltage, channel):
        ...
        Returns:
                int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPMX_getPositionAnalogOutputVoltageRange(
            self.devSession, minVoltage, maxVoltage, channel
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def getPositionAnalogOutputVoltage(self, attribute, voltageX, voltageY, channel):
        ...
        Returns:
                int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPMX_getPositionAnalogOutputVoltage(
            self.devSession, attribute, voltageX, voltageY, channel
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def measDualChannelSimultaneous(self, measurement, resultChannel1, resultChannel2):
        ...
        Returns:
                int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPMX_measDualChannelSimultaneous(
            self.devSession, measurement, resultChannel1, resultChannel2
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def measureCurrentMeasurementSequenceHWTrigger(self, baseTime, hPos, channel):
        ...
        Returns:
                int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPMX_measureCurrentMeasurementSequenceHWTrigger(
            self.devSession, baseTime, hPos, channel
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def measureVoltageMeasurementSequenceHWTrigger(self, baseTime, hPos, channel):
        ...
        Returns:
                int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPMX_measureVoltageMeasurementSequenceHWTrigger(
            self.devSession, baseTime, hPos, channel
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def getNextFastArrayMeasurementRelativeTime(self, count, timestamps, values, channel):
        ...
        Returns:
                int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPMX_getNextFastArrayMeasurementRelativeTime(
            self.devSession, count, timestamps, values, channel
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def confPowerMeasurementSequenceHWTrigger(self, trigSrc, baseTime, hPos, channel):
        ...
        Returns:
                int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPMX_confPowerMeasurementSequenceHWTrigger(
            self.devSession, trigSrc, baseTime, hPos, channel
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def confCurrentMeasurementSequenceHWTrigger(self, trigSrc, baseTime, hPos, channel):
        ...
        Returns:
                int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPMX_confCurrentMeasurementSequenceHWTrigger(
            self.devSession, trigSrc, baseTime, hPos, channel
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def confVolatgeMeasurementSequenceHWTrigger(self, trigSrc, baseTime, hPos, channel):
        ...
        Returns:
                int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPMX_confVolatgeMeasurementSequenceHWTrigger(
            self.devSession, trigSrc, baseTime, hPos, channel
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def confBurstArrayMeasTrigger(self, trgSource, initDelay, burstCount, averaging):
        ...
        Returns:
                int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPMX_confBurstArrayMeasTrigger(
            self.devSession, trgSource, initDelay, burstCount, averaging
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def getBurstArraySamples(self, startIndex, sampleCount, timeStamps, values, values2):
        ...
        Returns:
                int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPMX_getBurstArraySamples(
            self.devSession, startIndex, sampleCount, timeStamps, values, values2
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def setFanAdjustParameters(self, voltageMin, voltageMax, temperatureMin, temperatureMax, channel):
        ...
        Returns:
                int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPMX_setFanAdjustParameters(
            self.devSession, voltageMin, voltageMax, temperatureMin, temperatureMax, channel
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def getFanAdjustParameters(self, voltageMin, voltageMax, temperatureMin, temperatureMax, channel):
        ...
        Returns:
                int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPMX_getFanAdjustParameters(
            self.devSession, voltageMin, voltageMax, temperatureMin, temperatureMax, channel
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def identificationQuery(self, manufacturerName, deviceName, serialNumber, firmwareRevision):
        ...
        Returns:
                int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPMX_identificationQuery(
            self.devSession, manufacturerName, deviceName, serialNumber, firmwareRevision
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def getSensorInfo(self, name, snr, message, pType, pStype, pFlags, channel):
        ...
        Returns:
                int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPMX_getSensorInfo(
            self.devSession, name, snr, message, pType, pStype, pFlags, channel
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def getSensorInfoExt(self, name, snr, message, pType, pStype, pFlags, channel):
        ...
        Returns:
                int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPMX_getSensorInfoExt(
            self.devSession, name, snr, message, pType, pStype, pFlags, channel
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
